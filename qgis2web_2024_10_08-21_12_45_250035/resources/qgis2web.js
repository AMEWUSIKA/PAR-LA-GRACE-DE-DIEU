...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [1.205502, 6.031269, 1.634705, 6.288688], maxZoom: 28, minZoom: 6, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([1.205502, 6.031269, 1.634705, 6.288688], map.getSize());
    ...
    element: (() => {
        ...
        if (331 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ce projet de webmapping offre une analyse approfondie de la dynamique du littoral togolais en mettant en évidence les tendances historiques d\'érosion, les prévisions et les zones à risque. Dans le but d\'encourager les responsables à prendre conscience de l’ampleur du phénomène et à prendre des mesures radicales pour les résoudre.';
            }
